...
public final class PasswordHashTestData {
    private PasswordHashTestData() {
    }

    // VERSION 0x01: HKDF_HMAC512 - 23 Byte bcrypt
    public static final TestCaseHasher[] TEST_DATA_V1 = new TestCaseHasher[]{
    ...
    public static final TestCaseHasher[] TEST_DATA_V2 = new TestCaseHasher[]{
